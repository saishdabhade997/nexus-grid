...
app.post('/api/forgot-password', async (req, res) => {
    ...
    try {
        ...
        // --- SEND REAL EMAIL ---
        const resetLink = `http://localhost:3000/reset-password.html?token=${token}`; // Change localhost to your Render URL when deployed!
...
server.listen(PORT, () => {
    console.log(`🚀 NexusGrid Backend running on http://localhost:${PORT}`);
